...
def get_args_parser():
    ...
    parser.add_argument('--model_enc_lang', default='bert', choose=[
                        'bert', 'bilstm'], help='Choose the model to be used as language encoder')
    ...
    parser.add_argument('--bilstm_layers', default=4,
                        help='Number of Bi-LSTM layers.')
    parser.add_argument('--bilstm_out_dim', default=512,
                        help='Dimension of output features of the Bi-LSTM encoder.')
    parser.add_argument('--bilstm_dropout', default=0,
                        help='Dropout to use for the Bi-LSTM model.')
    parser.add_argument('--bilstm_hidden_dim', default=50,
                        help='Size of hidden state of LSTM')
    parser.add_argument('--lr_bilstm', default=0., type=float)

    # Visual encoder choice
    parser.add_argument('--model_enc_vis', default='detr', choices=[
                        'detr', 'resnet'], help='Choose the model to be used as visual encoder')
    ...
    parser.add_argument('--lr_resnet', default=0., type=float)
    ...
    parser.add_argument('--dconv_places', default='first_in_block', type=str, choices=['first_in_block', 'last_in_block', 'all'], help='Which conv layers do we replace with dconv?')
    ...
    parser.add_argument(
        '--detr_model', default='./saved_models/detr-r50.pth', type=str, help='detr model')
    parser.add_argument(
