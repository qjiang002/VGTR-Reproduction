...
# RefCOCO with BiLSTM + Visual Transformer
# python train.py --batch_size 8 --lr_bilstm 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model ../../checkpoints/detr-r50-unc.pth --bert_enc_num 12 --detr_enc_num 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco_r50 --model_enc_lang bilstm
# CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 --use_env train.py --batch_size 8 --lr_bilstm 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model ../../checkpoints/detr-r50-unc.pth --bert_enc_num 12 --detr_enc_num 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco_r50 --model_enc_lang bilstm

# RefCOCO with BERT + ResNet
# python train.py --batch_size 8 --lr_resnet 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model ../../checkpoints/detr-r50-unc.pth --bert_enc_num 12 --detr_enc_num 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco_r50 --model_enc_vis resnet
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 --use_env train.py --batch_size 8 --lr_resnet 0.00001 --aug_crop --aug_scale --aug_translate --backbone resnet50 --detr_model ../../checkpoints/detr-r50-unc.pth --bert_enc_num 12 --detr_enc_num 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco_r50 --model_enc_vis resnet
