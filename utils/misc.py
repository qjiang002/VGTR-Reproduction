...
class NestedTensor(object):
    def __init__(self, tensors, mask: Optional[Tensor], lang=None):
    ...
    def to(self, device):
        ...
        lang = self.lang
        if lang is not None:
            cast_lang = lang.to(device)
        else:
            cast_lang = None
        
        return NestedTensor(cast_tensor, cast_mask, cast_lang)

    def setLang(self, lang):
        self.lang = lang

    def decompose(self):
        return self.tensors, self.mask, self.lang
